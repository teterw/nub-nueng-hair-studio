  ...
  return (
    <footer className="border-t border-line">
      <div className="mx-auto w-full max-w-4xl px-5 py-12 sm:px-8">
        ...
        <address className="mt-2 max-w-[34ch] text-sm not-italic leading-relaxed text-coffee/70">
        ...
        <p className="mt-7 inline-block rounded-[3px] border border-line-strong px-2.5 py-1 text-xs text-coffee/70">
